namespace Neovolve.Windows.Forms
{
    ...
    /// <summary>
    ///     The <see cref="Neovolve.Windows.Forms.WizardButtonSettings" /> class stores the settings for a button control in
    ///     the
    ...
    public class WizardButtonSettings
    {
        ...
        ///     [enabled value].
        /// </param>
        public WizardButtonSettings(string textValue, bool enabledValue)
        ...
        ///     [visible value].
        /// </param>
        public WizardButtonSettings(string textValue, bool enabledValue, bool visibleValue)
        {
            Text = textValue;
